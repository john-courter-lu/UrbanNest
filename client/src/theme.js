...
export const themeSettings = (mode) => {
    const colors = tokens(mode);  // use tokens with the `mode`prop to decide colors
    return {
        palette: {
            mode: mode,
            ...(mode === "dark"
                ...
                : {
                    ...
                    background: {
                        default: "#fcfcfc", // light gray, manually changed
                    },
                }),
        },
        typography: {
            ...
            fontSize: 12,
            h1: { // variant font, all the same fontFamily, but different fontSize
                fontFamily: ["Source Sans Pro", "sans-serif"].join(","),
                fontSize: 40,
            },
            h2: {
