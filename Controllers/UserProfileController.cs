...
public class UserProfileController : ControllerBase
{
    ...
    public UserProfileController(UrbanNestDbContext context)
    {
        _dbContext = context;
    }
    ...
    // get UserProfiles with roles, as well as email and userName from IdentityUser, keep all the properties from UserProfile
    [HttpGet("withroles")]
    ...
    public IActionResult GetWithRoles()
    {
        ...
        .Select(up => new UserProfile
        {
            ...
            Address = up.Address,
            //need to add more like Zipcode, JoinedDate, isActive
